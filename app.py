...
# --- Données d’entrée
DEFAULT_INPUTS = {'604JFIC214.PV - weak phos acid condenst (M3/H)': 51.85, '604JTI211.PV - WEAK PHOS ACD CONDST CO0 (DEGC)': 51.815, '604JTI208.PV (°C)': 57.1, '604AFI063.PV - 5B STM FRM DISTRIBUTION (T/H)': 24.625, '604APIC066.PV - 5B STM TO DESUPERHEATER (BAR)': 1.975, '604ATI064.PV - 5B STM TO SEPARATOR (DEGC)': 156.07, '604ATI068A.PV - 2BARG STM TO EVAP J (°C)': 130.11, '604JFI221.PV - LP STEAM TO EVA AE02 (T/H)': 19.385, '604JTIC223.PV - LP STM FRM SEPARTOR A (DEGC)': 74.825, '604JPI225.PV (BAR)': -0.49, '604JPI226.PV - EVAP HEATR AE02 (BAR)': -0.03, '604JPI228.PV (BAR)': 1.865, '604JLI241.PV - FLSH CHAMBR AD01 (%)': 103.125, '604JPIC242.PV - FLASH CHAMBR AD01 (mm/hg)': 131.4, '604JPI246.PV - VAPOR TO FSA (mm/hg)': 133.85, '604JFIC250.PV - EVA PMP AP05 PHOS.ACID (M3/H)': 10.75, 'ACP29% entré Echelons': 1260.0}
...
def optimize_selected(input_vals, target, model, selected_vars, var_range=0.3):
    bounds = [(v * (1 - var_range), v * (1 + var_range)) if v != 0 else (-1, 1) for v in input_vals[selected_vars]]
    def obj(x):
        tmp = input_vals.copy()
        tmp[selected_vars] = x
...
<div style="text-align: center;">
    <img src="https://raw.githubusercontent.com/erochd/acp54-app/main/kofert.jpeg" style="width:3cm; height:auto;">
...
# --- Saisie des variables (en colonnes sur toute la largeur)
with st.form("form_pred"):
    ...
    for i, feat in enumerate(ALL_FEATURES):
        ...
        user[feat] = cols[i % 3].number_input(f"{feat}", value=default, key=feat, format="%.3f")
